"""Study-owned snapshot of the verified v2 observation reader.

Preserves original data equations with Python 3.8 path compatibility.
StudyDataset overrides record selection: no curriculum is inherited.
No source assets or original pipeline files are ever modified.
"""
