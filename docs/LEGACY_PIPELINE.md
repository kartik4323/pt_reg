# Archived pipeline guide

This is the historical README, retained for earlier experiments. The supported default is [reassembly v2](REASSEMBLY_V2.md). Paths in the original text below are relative to the repository root. Historical checkpoints and configs are not supported by v2.
