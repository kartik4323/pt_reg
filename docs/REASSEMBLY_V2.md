...
The shared encoder uses three PointNet++-style local aggregation levels with 256/128/64 groups, 128 channels and 1,024 XYZ points per fragment. Geometry objectives are surface segmentation, multi-positive local mating matches and pointwise transformed-view consistency. No whole-fragment compatibility attraction or fragment dropout is used. Augmentation teaches rotation robustness; no exact SE(3) invariance claim is made.
